...
//    [RequireComponent(typeof(NetworkIdentity))]
    public class MasterAudioMultiplayerAdapter : MonoBehaviour {
        ...
        /// <summary>
        /// This calls MasterAudio.InvokeParameterCommand
        /// </summary>
        /// <param name="actor"></param>
        /// <param name="parameterCommandName"></param>
        /// <returns>Guid?</returns>
        public static Guid? InvokeParameterCommand(Transform actor, string parameterCommandName) {
            return null;
        }

        /// <summary>
        /// This calls MasterAudio.StopParameterCommandsByCommandName
        /// </summary>
        /// <param name="actor"></param>
        /// <param name="parameterCommandName"></param>
        ...
        /// <summary>
        /// This calls MasterAudio.StopParameterCommandsOfTransform
        /// </summary>
        /// <param name="actor"></param>
        ...
        /// <summary>
        /// This calls MasterAudio.UpdateRealTimeParameter
        /// </summary>
        /// <param name="actor"></param>
