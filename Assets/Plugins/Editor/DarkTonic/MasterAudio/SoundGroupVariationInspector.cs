        ...
        public override void OnInspectorGUI()
        {
            ...
            if (!isVideoPlayersGroup)
            {
                ...
                if (_variation.VarAudio.loop) {
                    var newReRandomize = EditorGUILayout.Toggle("Re-randomize On Loop", _variation.reReRandomizeOnLoop);
                    if (newReRandomize != _variation.reReRandomizeOnLoop) {
                        AudioUndoHelper.RecordObjectPropertyForUndo(ref isDirty, _variation, "toggle Re-randomize On Loop");
                        _variation.reReRandomizeOnLoop = newReRandomize;
                    }
                }
