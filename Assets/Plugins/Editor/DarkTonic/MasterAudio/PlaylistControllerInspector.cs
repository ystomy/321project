...
namespace DarkTonic.MasterAudio.EditorScripts
{
    ...
    public class PlaylistControllerInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var newBypassReverbZones = EditorGUILayout.Toggle("Bypass Reverb Zones", controller.bypassReverbZones);
            if (newBypassReverbZones != controller.bypassReverbZones) {
                AudioUndoHelper.RecordObjectPropertyForUndo(ref isDirty, controller, "toggle Bypass Reverb Zones");
                controller.bypassReverbZones = newBypassReverbZones;
            }
