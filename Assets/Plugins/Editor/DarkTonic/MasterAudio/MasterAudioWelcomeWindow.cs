...
namespace DarkTonic.MasterAudio.EditorScripts
{
    ...
    public class MasterAudioWelcomeWindow : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            if (GUILayout.Button("Official Forum", GUILayout.Width(100))) {
                Application.OpenURL("http://darktonic.freeforums.net/board/1/master-audio-aaa-sound-solution");
            }
            if (GUILayout.Button("Official Discord", GUILayout.Width(100))) {
                Application.OpenURL("https://discord.gg/JvdXq68");
            }
