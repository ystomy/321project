...
namespace PixelCrushers.DialogueSystem.PlayMaker
{
    ...
    [HutongGames.PlayMaker.Tooltip("Syncs a quaternion array variable between PlayMaker and the Dialogue System's Variable[] Lua table.")]
    public class SyncQuaternionArray : FsmStateAction
    {
        ...
        private void Sync()
        {
            ...
            else
            {
                ...
                {
                    playMakerVariable.Values = DialogueSystemPlayMakerTools.StringToArray(DialogueLua.GetVariable(dialogueSystemVariable.Value).AsString, VariableType.Quaternion);
                }
            }
        }
