...
namespace PixelCrushers.DialogueSystem.PlayMaker
{
    ...
    [HutongGames.PlayMaker.Tooltip("Syncs a bool array variable between PlayMaker and the Dialogue System's Variable[] Lua table.")]
    public class SyncBoolArray : FsmStateAction
    {
        ...
        private void Sync()
        {
            ...
            else
            {
                ...
                {
                    playMakerVariable.Values = DialogueSystemPlayMakerTools.StringToArray(DialogueLua.GetVariable(dialogueSystemVariable.Value).AsString, VariableType.Bool);
                }
            }
        }
