...
namespace PixelCrushers.DialogueSystem.PlayMaker
{
    ...
    [HutongGames.PlayMaker.Tooltip("Syncs an int array variable between PlayMaker and the Dialogue System's Variable[] Lua table.")]
    public class SyncIntArray : FsmStateAction
    {
        ...
        private void Sync()
        {
            ...
            else
            {
                ...
                {
                    playMakerVariable.Values = DialogueSystemPlayMakerTools.StringToArray(DialogueLua.GetVariable(dialogueSystemVariable.Value).AsString, VariableType.Int);
                }
            }
        }
