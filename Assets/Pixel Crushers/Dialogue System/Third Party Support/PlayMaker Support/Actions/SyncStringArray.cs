...
namespace PixelCrushers.DialogueSystem.PlayMaker
{
    ...
    [HutongGames.PlayMaker.Tooltip("Syncs a string array variable between PlayMaker and the Dialogue System's Variable[] Lua table.")]
    public class SyncStringArray : FsmStateAction
    {
        ...
        private void Sync()
        {
            ...
            else
            {
                ...
                {
                    playMakerVariable.Values = DialogueSystemPlayMakerTools.StringToArray(DialogueLua.GetVariable(dialogueSystemVariable.Value).AsString, VariableType.String);
                }
            }
        }
