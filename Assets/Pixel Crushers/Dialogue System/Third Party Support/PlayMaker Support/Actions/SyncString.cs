...
namespace PixelCrushers.DialogueSystem.PlayMaker
{
    ...
    [HutongGames.PlayMaker.Tooltip("Syncs a string variable between PlayMaker and the Dialogue System's Variable[] Lua table.")]
    public class SyncString: FsmStateAction
    {
        ...
        public override void Reset()
        {
            ...
            playMakerVariable = new FsmString { UseVariable = true };
        ...
        private void Sync()
        {
            ...
            {
                LogWarning(DialogueDebug.Prefix + ": PlayMaker Variable isn't assigned.");
            }
            else
            {
