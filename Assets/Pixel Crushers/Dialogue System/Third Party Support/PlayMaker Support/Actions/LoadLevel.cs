        ...
        public override void OnEnter()
        {
            ...
            else
            {
                ...
                if (saveSystem != null)
                {
                    ...
                    var sceneNameAndSpawnpoint = string.IsNullOrEmpty(spawnpoint.Value) ? levelName.Value : levelName.Value + "@" + spawnpoint.Value;
                    if (additive)
                    {
                        SaveSystem.LoadAdditiveScene(sceneNameAndSpawnpoint); // Note: Additive doesn't use spawnpoint.
                    }
                    else
                    {
